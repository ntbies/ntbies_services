...
class DocumentExtractLines(models.Model):
    ...
    def get_as_line(self):
        ...
        tax_id = self.find_purchase_tax_by_percentage(self.tax) or product.taxes_id
        return {
    ...
    def find_purchase_tax_by_percentage(self, tax_percentage):
        ...
        return self.env["account.tax"].search(domain, limit=1) or None
